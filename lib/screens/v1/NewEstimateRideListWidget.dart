...
import '../../screens/v1/ReviewScreen.dart';
...
class NewEstimateRideListWidgetState extends State<NewEstimateRideListWidget> {
  ...
  double calculateTotalAmount({required ServicesListData? serviceList}) {
    ...
    num? distancePrice = (distance ?? 0) * (perDistance ?? 0);

    num? timePrice = (duration ?? 0) * (perMinuteDrive ?? 0);
    num? totalAmount = (baseFare ?? 0) + (distancePrice + timePrice);
